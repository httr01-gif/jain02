...
async function askJSON(prompt){
  ...
  if(s < 0) throw new Error("JSON 형식이 아닌 응답");
...
교수·학습 과정안 본문을 작성하라. 도입 → 전개 → 정리 3단계.
...
{"intro":{"process":"수업 준비\\n동기 유발\\n학습목표 확인\\n학습활동 안내","teacher":"...","levelA":"...","levelB":"...","levelC":"...","material":"..."},
"develop":[{"process":"활동1 ...","teacher":"...","levelA":"...","levelB":"...","levelC":"...","material":"..."},{"process":"활동2 ...","teacher":"...","levelA":"...","levelB":"...","levelC":"...","material":"..."}],
"close":{"process":"정리 및 평가\\n차시 예고\\n인사·마무리","teacher":"...","levelA":"...","levelB":"...","levelC":"...","material":"..."}}${RULE}`;
...
async function generateDocument(){
  ...
  try{
    say('1/3 · 수업설계 의도를 작성하고 있습니다');   const a = await askJSON(P1(c.text));
    say('2/3 · 도입·전개·정리를 구성하고 있습니다');   const b = await askJSON(P2(c.text));
    say('3/3 · 개별지원과 평가계획을 작성하고 있습니다'); const e = await askJSON(P3(c.text));
