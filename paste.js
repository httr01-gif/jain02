/* ═══════════════════════════════════════════════════════════
   붙여넣기 → 한글파일 변환 경로 (v3.5)
   ───────────────────────────────────────────────────────────
   v3.4 변경  학생 특성 AI 추출 라벨 추가, 개별 지원 방안 구체화
...
· 학생-특성 칸은 입력된 학생 특성을 그대로 옮기지 말고 분석하여, 이 수업의 활동과 목표에 직접 관련된 핵심 특성만 1~2줄 씁니다.
  줄마다 "- "로 시작, 35자 이내입니다. "학습자는", "학생은" 같은 주어 없이 "~함", "~있음" 형태로 끝냅니다.
  보기 - 그림 단서가 있으면 두 개 중 하나를 고를 수 있음. 수업과 관계없는 특성과 IEP 목표는 쓰지 않습니다.
· 학생-지원 칸은 어느 활동에서 어떤 AI 제작 자료를 어떻게 제시하고 어떤 촉구로 수행을 돕는지 구체적으로 1~2줄 씁니다.
  줄마다 "- "로 시작, 40~60자 명사형입니다. 보기 - 활동1에서 AI 제작 장면 카드를 2장으로 줄여 제시하고 손짓 촉구로 선택 지원
